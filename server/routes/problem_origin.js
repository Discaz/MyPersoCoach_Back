...
router.get ('/', (req, res) =>{
    connection.query(`select problem_origin.id, all_text, picture_src, description_alt from problem_origin join text_static ts on problem_origin.text_static_id = ts.id join icon on problem_origin.icon_id = icon.id`,(err, results) => {
